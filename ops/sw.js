...
// v2 — fixes the offline fallback bug (net is a promise, always
// truthy, so the old `cached || net || match` never fell back),
// caches each file individually, and includes the app's own icons.
// ============================================================
const CACHE = 'ops-planner-v2';
const CORE = [
  './',
  'index.html',
  'manifest.json',
